package com.company; /**
 * Created by Дмитрий on 07.11.2016.
 */
...
public abstract class CommandProcessor {
    ...
    public final int EXCEPTION = 0x00400000;
    public final int REQUEST_DATA=0x00800000;/* requesting data(up to 7bit e.q 255 lines from the commands file)
     for the command, for example for filling rows in table
    */
    public final int RESULT_IS_TRUE = 0x01000000;
            ...
            if (command.equals(m.getName())&&(!command.equals("doCommand"))){
                ...
                try {
                    ...
                    try {
                        ...
                        setStatusMessage("Exception occurs: "+throwable.getMessage());
